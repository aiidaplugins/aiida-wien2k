...
class Wien2kRun123Lapw(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.input(
            ...
            required=False,
            help='WIEN2k input structure file case.struct',
        )
        ...
        # exit codes
        spec.exit_code(400, 'ERROR_ITER_0', message='Unable to perform even a single SCF iteration.')
        spec.exit_code(
            401, 'ERROR_MISSING_OUTPUT_FILES', message='Calculation did not produce all expected output files.'
        )
        spec.exit_code(302, 'WARNING_QTL_B', message='WARN: QTL-B in the last iteration.')
        spec.exit_code(312, 'WARNING_QTL_B1', message='WARN: QTL-B in the last iteration prec1.')
        spec.exit_code(322, 'WARNING_QTL_B2', message='WARN: QTL-B in the last iteration prec2.')
        spec.exit_code(332, 'WARNING_QTL_B3', message='WARN: QTL-B in the last iteration prec3.')
        spec.exit_code(303, 'WARNING_VK_COUL', message='WARN: VK-COUL is not well converged.')
        spec.exit_code(313, 'WARNING_VK_COUL1', message='WARN: VK-COUL is not well converged prec1.')
        spec.exit_code(323, 'WARNING_VK_COUL2', message='WARN: VK-COUL is not well converged prec2.')
        spec.exit_code(333, 'WARNING_VK_COUL3', message='WARN: VK-COUL is not well converged prec3.')
        spec.exit_code(304, 'WARNING_INT', message='WARN: Integrated number of electrons is not consistent.')
        spec.exit_code(314, 'WARNING_INT1', message='WARN: Integrated number of electrons is not consistent prec1.')
        spec.exit_code(324, 'WARNING_INT2', message='WARN: Integrated number of electrons is not consistent prec2.')
        spec.exit_code(334, 'WARNING_INT3', message='WARN: Integrated number of electrons is not consistent prec3.')
        spec.exit_code(305, 'WARNING_CONVERG', message='WARN: SCF is not converged.')
        spec.exit_code(315, 'WARNING_CONVERG1', message='WARN: SCF prec1 is not converged.')
        spec.exit_code(325, 'WARNING_CONVERG2', message='WARN: SCF prec2 is not converged.')
        spec.exit_code(335, 'WARNING_CONVERG3', message='WARN: SCF prec3 is not converged.')
        spec.exit_code(309, 'WARNING_OTHER', message='WARN: There is a warning in the last SCF iteration.')
        spec.exit_code(319, 'WARNING_OTHER1', message='WARN: There is a warning in the last SCF iteration prec1.')
        spec.exit_code(329, 'WARNING_OTHER2', message='WARN: There is a warning in the last SCF iteration prec2.')
        spec.exit_code(339, 'WARNING_OTHER3', message='WARN: There is a warning in the last SCF iteration prec3.')
